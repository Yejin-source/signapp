...
<script>
	$(document).ready(function() {  
		...
		// SignaturePad API 설명은 https://github.com/szimek/signature_pad 페이지 readme 파일 API 부분 참고
		const signaturePad = new SignaturePad($('canvas')[0], { // 첫 번째 캔버스 태그 가져오기
			minWidth: 2,
		    maxWidth: 2,
		    penColor: "rgb(0, 0, 0)" // #000000
		});
		...
		$('#btnSign').click(function() {
			if(signaturePad.isEmpty()) {
				...
				$.ajax({
					...
					} // 로그인 사용자 id와 SignaturePad 객체 안의 사인 이미지
				}).done(function(data) {
					alert(data); // data = 결재 완료
...
<body>
	...
	<div id="id">manager</div> <!-- <input type="text" id="id" value="manage"> -->
	<canvas style="border: 1px solid #FF0000;"></canvas>
	<br>
	<button type="button" id="btnClear">지우기</button>
	<button type="button" id="btnSign">결재하기</button>
</body>
</html>
